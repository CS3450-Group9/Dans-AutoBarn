...
def populate_db(apps, schema_editor):
    ...
    res1 = Reservation(car=car1, user=new_admin, start_date=start_date, end_date=end_date)
    res2 = Reservation(car=car2, user=new_customer, start_date=start_date, end_date=end_date)
    res1.save()
    res2.save()
